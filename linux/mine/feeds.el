(setq elfeed-feeds
      '(("https://recorder.ro/feed/" ro)
		...
		("https://www.youtube.com/feeds/videos.xml?channel_id=UC1yGcBvdPGxRIMT1yo_bKIQ" yt linux)			;; Jake @ Linux
		("https://www.youtube.com/feeds/videos.xml?channel_id=UCsBjURrPoezykLs9EqgamOA" yt foss)			;; Fireship
		("https://www.youtube.com/feeds/videos.xml?channel_id=UCgWip0vxtqu34rZrFeCpUow" yt linux cs)		;; Tim R Morgan
		("https://www.youtube.com/feeds/videos.xml?channel_id=UCrqM0Ym_NbK1fqeQG2VIohg" yt linux cs)		;; Tsoding Daily
		))
