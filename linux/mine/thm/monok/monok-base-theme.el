...
(defun monok-transform-spec (spec colors)
      ...
      (let* ((key       (car  spec))
        ...
        (cond
         ((and (memq key '(:box :underline)) (listp value))
          (setq output (append output (list key (monok-transform-spec value colors)))))
         (color
...
(defun monok-transform-face (spec colors)
  "Transform a face `SPEC' into an Emacs theme face definition using `COLORS'."
  (let* ((face         (car spec))
         (definition   (cdr spec)))
    (list face `((((type graphic)) ,(monok-transform-spec definition colors))))))


(defun monok-set-faces (theme-name colors faces)
  ...
  (apply 'custom-theme-set-faces theme-name
         (mapcar #'(lambda (face)
                     (monok-transform-face face colors))
                 faces)))

(defun monok-theme-define (theme-name theme-colors)
  "Define the faces for a monok colorscheme given a `THEME-NAME' and a plist of `THEME-COLORS'."
  (monok-set-faces
   theme-name
   theme-colors
   '(
...
;;;; basic colors
     ...
     (cursor                                       :background zgreen :foreground nil)
     (default                                      :foreground zwhite :background zblack)
     (fringe                                       :background nil)
     (gui-element                                  :background zgrey3)
     (header-line                                  :foreground zred :box (:color zgrey1 :style pressed-button))
     ...
     (region                                       :background zyellow :foreground zblack)
     (secondary-selection                          :background zgrey2)
     (trailing-whitespace                          :foreground zyellow :background zgrey1)
     (widget-button                                :underline t)
     (widget-field                                 :background zgrey2)
     (bold                                          :foreground zwhite :weight bold)
     (italic                                        :foreground zwhite :slant normal)
     (bold-italic                                   :foreground zwhite :slant italic :weight bold)
     ...
     (active-hole-face                              :foreground zblack :background zred)
...
;;;; font-lock
     ...
     (font-lock-function-name-face                 :foreground zyellow)
...
;;;; isearch
     ...
     (isearch                                      :foreground zgreen :background pureblack :inverse-video t)
     (isearch-lazy-highlight-face                  :foreground zcyan :background pureblack :inverse-video nil)
     (isearch-fail                                 :background zred :foreground zblack)
     (lazy-highlight                               :inherit isearch-lazy-highlight-face)

;;;; mode-line
     (mode-line                                    :foreground zwhite :box (:color zgrey1 :line-width 2 :style released-button))
     (mode-line-buffer-id                          :foreground zgreen :weight bold)
     (mode-line-emphasis                           :foreground zyellow)
     (mode-line-highlight                          :foreground zred :weight bold)
...
;;;; elfeed
     ...
     (elfeed-search-title-face                      :foreground zwhite)
...
;;;; mu4e
     ...
     (mu4e-header-face                              :foreground zwhite)
...
;;;; auctex
      (font-latex-bold-face                         :foreground zwhite :weight bold)
...
;;;; company-mode
      (company-tooltip                              :background zblack :foreground zwhite :box (:line-width 1 :style released-button))
      (company-scrollbar-bg                         :background zblack)
      (company-scrollbar-fg                         :background zgrey1)
      (company-tooltip-annotation                   :foreground zred)
      (company-tooltip-common                       :inherit font-lock-constant-face)
      (company-tooltip-selection                    :background zgreen :foreground zblack :box (:line-width 1 :style pressed-button))
...
;;;; erc
      ...
      (erc-header-face                              :foreground zwhite :background zgrey4)
...
;;;; gnus
      ...
      (gnus-summary-normal-read                     :foreground zwhite :weight normal)
...
;;;; helm
      ...
      (helm-candidate-number                        :foreground zblack :background zorange)
      ...
      (helm-ff-invalid-symlink                      :foreground zblack :background zred)
      ...
      (helm-grep-finish                             :foreground zblack :background zorange)
      (helm-grep-lineno                             :foreground zgrey2)
      (helm-grep-match                              :foreground zyellow)
      (helm-grep-running                            :foreground zorange)
      (helm-header                                  :foreground zyellow :background zblack :underline nil)
      ...
      (helm-source-header                           :foreground zwhite :background zgrey3 :weight bold)
      (helm-visible-mark                            :foreground zblack :background zgreen)
...
;;;; ido-mode
      (ido-first-match                              :foregrond zwhite :weight bold)
      (ido-incomplete-regexp                        :foreground zred)
      (ido-indicator                                :foreground zblack :background zred)
      (ido-only-match                               :foreground zgreen)
      (ido-subdir                                   :foreground zred)
      (ido-virtual                                  :foreground zred)
...
;;;; org-mode
      (org-block-begin-line                         :foreground zgrey3)
      ...
      (org-block                                    :foreground zwhite :background nil) ;; "#afafaf")
...
;;;; calendar
      (calendar-today                               :foreground zblack :background zyellow)
      (calendar-weekend-header                      :foreground zred)
      (calendar-weekday-header                      :foreground zgreen)
      (calendar-month-header                        :foreground zcyan :weight bold)
...
;;;; rainbow-delimiters
      ...
      (rainbow-delimiters-depth-9-face              :foreground zwhite)
...
;;;; CUSTOMIZE
      (custom-changed                               :foreground zwhite :background zblue)
      ...
      (custom-documentation                         :foreground zwhite)
      (custom-face-tag                              :foreground zblue :height 1.1)
      (custom-group-subtitle                        :foreground zwhite :weight bold)
      (custom-group-tag                             :foreground zblue :height 1.1)
      (custom-group-tag-1                           :foreground zorange :height 1.2 :weight bold)
      (custom-invalid                               :foreground zblack :background zred)
      (custom-modified                              :foreground zwhite :background zblue)
      (custom-rogue                                 :background zblack :foreground zred)
      (custom-saved                                 :foreground zwhite :underline t)
      (custom-set                                   :background zwhite :foreground zblue)
      (custom-state                                 :foreground zgreen)
      (custom-themed                                :background zblue :foreground zwhite)
      (custom-variable-button                       :foreground zwhite :underline t)
...
;;;; INFO
      ...
      (info-header-node                             :foreground zwhite :weight bold)
      (info-header-xref                             :inherit link)
      (info-menu-header                             :foreground zwhite :weight bold)
      (info-menu-star                               :foreground zred)
      (info-node                                    :foreground zwhite)
...
;;;; AGDA
      (agda2-highlight-catchall-clause-face         :background zyellow :foreground zblack)
      (agda2-highlight-coinductive-constructor-face :foreground zgreen)
      (agda2-highlight-bound-variable-face          :foreground zwhite)
      (agda2-highlight-coverage-problem-face        :foreground zblack :background zcyan)
      (agda2-highlight-datatype-face                :foreground zcyan)
      (agda2-highlight-deadcode-face                :foreground zwhite :background zgrey1)
      (agda2-highlight-dotted-face                  :inherit default)
      (agda2-highlight-error-face                   :foreground zred)
      (agda2-highlight-field-face                   :foreground zred)
      (agda2-highlight-function-face                :foreground zorange)
      (agda2-highlight-generalizable-variable-face  :inherit font-lock-variable-name-face)
      (agda2-highlight-inductive-constructor-face   :foreground zgreen)
      (agda2-highlight-keyword-face                 :inherit font-lock-keyword-face)
      (agda2-highlight-macro-face                   :foreground zblue)
      (agda2-highlight-module-face                  :foreground zyellow)
      (agda2-highlight-number-face                  :foreground zcyan)
      (agda2-highlight-operator-face                :foreground zyellow)
      (agda2-highlight-positivity-problem-face      :background zyellow :foreground zblack)
      (agda2-highlight-postulate-face               :foreground zblue :weight bold)
      (agda2-highlight-pragma-face                  :foreground zgreen)
      ...
      (agda2-highlight-symbol-face                  :foreground zyellow) 
      (agda2-highlight-termination-problem-face     :foreground zred)
      (agda2-highlight-typechecks-face              :background zcyan :foreground zblack)
      (agda2-highlight-unsolved-constraint-face     :background zyellow :foreground zblack)
      (agda2-highlight-unsolved-meta-face           :background zyellow :foreground zblack)

;;;; COQ
      (coq-button-face                              :foreground zwhite :box (:color zgrey1 :style released-button))
      (coq-button-face-pressed                      :foreground zwhite :box (:color zgrey1 :style pressed-button))
      (coq-cheat-face                               :foreground zred)
      (coq-context-qualifier-face                   :foreground zblue :weight bold)
      (coq-question-mark-face                       :foreground zyellow)
      (coq-solve-tactics-face                       :foreground zgreen)
      (coq-symbol-binder-face                       :foreground zcyan)
      (coq-symbol-face                              :foreground zcyan)
...
;;;; term and ansi-term
      (term                                         :foreground zwhite :background zblack)
      (term-color-black                             :foreground zgrey1 :background zblack)
      (term-color-white                             :foreground zwhite :background zwhite)
...
;;;; undo-tree-mode
      (undo-tree-visualizer-default-face            :foreground zwhite)
...
;;;; whitespace-mode
   ...
   (let ((zblack (plist-get theme-colors :zblack))
         ...
         (zwhite (plist-get theme-colors :zwhite))
         (zwhite (plist-get theme-colors :zwhite))
         (zwhite (plist-get theme-colors :zwhite))
