...
;; URL: https://github.com/my-dracula/emacs
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'my-dracula
   ;; default
   `(error ((,class (:foreground ,rainbow-8))))
   `(bold ((,class (:weight normal :foreground ,func))))
   `(italic ((,class (:weight normal :foreground ,str)))) 
   `(cursor ((,class (:background ,rainbow-2))))
   ...
   ;; font-latex
   `(font-latex-sedate-face ((,class (:foreground ,keyword))))
   `(font-latex-bold-face ((,class (:foreground ,const))))
   `(font-latex-italic-face ((,class (:foreground ,const))))
   `(font-latex-match-reference-keywords ((,class (:foreground ,const))))
   `(font-latex-match-variable-keywords ((,class (:foreground ,var))))
   `(font-latex-string-face ((,class (:foreground ,str))))
   `(font-latex-warning-face ((,class (:foreground ,rainbow-9))))
   `(font-latex-math-face ((,class (:foreground ,str))))
   ;; gnus-group
   `(gnus-group-mail-1 ((,class (:foreground ,keyword :bold nil))))
   `(gnus-group-mail-1-empty ((,class (:inherit gnus-group-mail-1 :bold nil))))
   `(gnus-group-mail-2 ((,class (:foreground ,const :bold nil))))
   `(gnus-group-mail-2-empty ((,class (:inherit gnus-group-mail-2 :bold nil))))
   `(gnus-group-mail-3 ((,class (:foreground ,comment :bold nil))))
   `(gnus-group-mail-3-empty ((,class (:inherit gnus-group-mail-3 :bold nil))))
   `(gnus-group-mail-low ((,class (:foreground ,bg5 :bold nil))))
   `(gnus-group-mail-low-empty ((,class (:inherit gnus-group-mail-low :bold nil))))
   `(gnus-group-news-1 ((,class (:foreground ,keyword :bold nil))))
   `(gnus-group-news-1-empty ((,class (:inherit gnus-group-news-1 :bold nil))))
   `(gnus-group-news-2 ((,class (:foreground ,const :bold nil))))
   `(gnus-group-news-2-empty ((,class (:inherit gnus-group-news-2 :bold nil))))
   `(gnus-group-news-3 ((,class (:foreground ,comment :bold nil))))
   ...
   `(gnus-group-news-low ((,class (:foreground ,bg5 :bold nil))))
   ...
   `(mode-line-buffer-id ((,class (:foreground ,rainbow-2))))
   ;; mu4e
   ...
   `(org-document-title ((,class (:weight normal :foreground ,rainbow-5 :height 1.44))))
   ...
   `(org-level-1 ((,class (:foreground ,rainbow-4 :height 1.3))))
   `(org-level-2 ((,class (:foreground ,rainbow-3 :height 1.1))))
   ...
   `(org-tag ((,class (:foreground ,rainbow-4 :bold nil :background ,bg2))))
   `(org-todo ((,class (:foreground ,rainbow-5 :bold nil :background ,bg2))))
   `(org-upcoming-deadline ((,class (:foreground ,rainbow-7))))
   `(org-warning ((,class (:weight normal :foreground ,rainbow-4))))
   ;; outline
   ...
   `(web-mode-html-tag-face ((,class (:foreground ,keyword :bold nil))))
   ...
   `(dired-mark ((,class (:foreground ,var :weight normal))))
   `(dired-marked ((,class (:foreground ,builtin :weight normal))))
   ...
   `(diredp-deletion ((,class (:foreground ,keyword :weight normal))))
   ...
   `(diredp-flag-mark ((,class (:foreground ,fg2 :weight normal :background ,bg5))))
